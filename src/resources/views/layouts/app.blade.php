    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-secondary-50">
            ...
            <main>
                ...
                @if(session('error'))
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-4">
                        <div class="bg-error-100 border border-error-400 text-error-700 px-4 py-3 rounded-lg relative" role="alert">
                ...
                @if(session('info'))
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-4">
                        <div class="bg-primary-100 border border-primary-400 text-primary-700 px-4 py-3 rounded-lg relative" role="alert">
