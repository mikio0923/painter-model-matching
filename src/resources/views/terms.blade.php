    ...
    <section class="section-panel">
        <div class="section-panel-inner">
            ...
            <div class="prose prose-sm max-w-none text-secondary-700 leading-relaxed space-y-6">
                ...
                <section>
                    <h2 class="text-lg font-bold text-secondary-900 mt-8 mb-3">第4条（年齢制限・本人性の確認）</h2>
                    <ol class="list-decimal list-inside space-y-2 text-sm">
                        <li>当サービスは<strong>18歳以上の方</strong>のみご利用いただけます。18歳未満の方の登録は固くお断りします。</li>
                        <li>当サービスは、利用者の身分証等による本人確認は実施しておりません。利用者同士のやりとりにおける本人性・実在性は、プロフィール画像・ポートフォリオ等を参考に、利用者ご自身の判断と責任でご確認ください。</li>
                        <li>当サービスの利用にあたり登録情報に虚偽があった場合、または虚偽の表示・なりすまし等が確認された場合、当社はアカウントを直ちに停止または削除することができます。</li>
                    </ol>
                </section>
