    ...
    <div class="page-header-inner">
        ...
        <div class="mt-4">
            <a href="{{ route('jobs.show', $job) }}"
               class="inline-flex items-center gap-2 px-5 py-2 bg-secondary-900 text-canvas-50 border border-secondary-900 text-sm hover:bg-canvas-50 hover:text-secondary-900 transition-colors duration-200">
